...
relational databases are tables that have columns that can reference other tables' columns, SQL is the language they can be written in

2. Why do tables need a `primary key`?

so each peice of data can be referenced specifically
